...
export default function N4GrammarLesson37Page() {
  ...
  const saveNotes = () => {
    ...
    localStorage.setItem('n4-grammar-lesson37-notes', notes);
  ...
  const loadNotes = () => {
    ...
    const savedGrammarNotes = localStorage.getItem('n4-grammar-lesson37-grammar-notes');
  ...
  const saveGrammarNote = (patternId: string, content: string) => {
    ...
    localStorage.setItem('n4-grammar-lesson37-grammar-notes', JSON.stringify(newGrammarNotes));
  };
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('/api/grammar/n4/lesson37');
        if (response.ok) {
          const data = await response.json();
          setLessonData(data);
        } else {
          // Fallback to static data
          const staticData = await import('../../../../../../../data/jlpt-n4/B37.json');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 flex justify-between">
          ...
          <Link
            href="/courses/japanese/n4/grammar/lesson/38"
