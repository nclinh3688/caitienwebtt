...
export default function N5GrammarLesson6Page() {
  ...
  const saveNotes = () => {
    localStorage.setItem('n5-grammar-lesson6-notes', notes);
    setShowNotesModal(false);
  };

  const loadNotes = () => {
    const savedNotes = localStorage.getItem('n5-grammar-lesson6-notes');
    if (savedNotes) {
      setNotes(savedNotes);
    }
    
    const savedGrammarNotes = localStorage.getItem('n5-grammar-lesson6-grammar-notes');
  ...
  const saveGrammarNote = (patternId: string, content: string) => {
    ...
    localStorage.setItem('n5-grammar-lesson6-grammar-notes', JSON.stringify(newGrammarNotes));
  };
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2">Bài 6: Tính từ và mô tả</h1>
              <p className="text-lg text-gray-600 mt-1">第6課 - けいようしとびょうしゃ</p>
            </div>
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="bg-yellow-100 p-4 rounded-lg mb-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">1. いadj です</h3>
                  <p className="text-lg font-medium text-blue-800 mb-2">Tính từ i-adjective</p>
                  <p className="text-base text-gray-700">Tính từ i-adjective</p>
                </div>
