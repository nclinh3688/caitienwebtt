...
export default function N5GrammarLesson8Page() {
  ...
  const saveNotes = () => {
    localStorage.setItem('n5-grammar-lesson8-notes', notes);
    setShowNotesModal(false);
  };

  const loadNotes = () => {
    const savedNotes = localStorage.getItem('n5-grammar-lesson8-notes');
    if (savedNotes) {
      setNotes(savedNotes);
    }
    
    const savedGrammarNotes = localStorage.getItem('n5-grammar-lesson8-grammar-notes');
  ...
  const saveGrammarNote = (patternId: string, content: string) => {
    ...
    localStorage.setItem('n5-grammar-lesson8-grammar-notes', JSON.stringify(newGrammarNotes));
  };
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2">Bài 8: Thời gian và hành động</h1>
              <p className="text-lg text-gray-600 mt-1">第8課 - じかんとこうどう</p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="bg-yellow-100 p-4 rounded-lg mb-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">1. ～に ～ます</h3>
                  <p className="text-lg font-medium text-blue-800 mb-2">Thời gian + hành động</p>
                  <p className="text-base text-gray-700">Thời gian + hành động</p>
                </div>
                
                <div className="bg-gray-100 p-4 rounded-lg mb-4">
                  <p className="text-gray-700 leading-relaxed">
                    ここ、そこ、あそこ là các đại danh từ chỉ nơi chốn. ここ chỉ chỗ của người nói, そこ là chỗ của người nghe, あそこ chỉ nơi xa cả hai người
                  </p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="border border-gray-200 rounded-lg">
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                                                  <div className="text-lg font-medium text-gray-900 mb-1">ここは きょうしつです。</div>
                        <div className="text-base text-gray-700 mb-1">ここは きょうしつです。</div>
                        <div className="text-sm text-gray-600">Đây là phòng học.</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                                                  <div className="text-lg font-medium text-gray-900 mb-1">そこは おてあらいです。</div>
                        <div className="text-base text-gray-700 mb-1">そこは おてあらいです。</div>
                        <div className="text-sm text-gray-600">Đó là nhà vệ sinh.</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                                                  <div className="text-lg font-medium text-gray-900 mb-1">あそこは しょくどうです。</div>
                        <div className="text-base text-gray-700 mb-1">あそこは しょくどうです。</div>
                        <div className="text-sm text-gray-600">Kia là nhà ăn tập thể.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 2:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-2-example-1`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-2-example-1`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">このほんは にほんごのほんです。</div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 3:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-2-example-2`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-2-example-2`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">そのくるまは たかいです。</div>
                  ...
                  <div className="space-y-3">
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 1:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-3-example-0`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-3-example-0`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">これは なんですか。</div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 2:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-3-example-1`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-3-example-1`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">…それは いすです。</div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 3:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-3-example-2`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-3-example-2`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">このひとは だれですか。</div>
                  ...
                  <div className="space-y-3">
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 1:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-4-example-0`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-4-example-0`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">これは えんぴつですか。</div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 2:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-4-example-1`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-4-example-1`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">…はい、そうです。</div>
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <span className="font-medium text-gray-700">Ví dụ 3:</span>
                        <button
                          onClick={() => toggleExamples(`pattern-4-example-2`)}
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                            showExamples[`pattern-4-example-2`]
                              ? 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                        >
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                        ...
                        <div className="p-4 bg-gray-50">
                          ...
                          <div className="text-base text-gray-700 mb-1">それは テレホンカードですか。</div>
        ...
        <div className="mt-8 flex justify-between">
          <Link
            href="/courses/japanese/n5/grammar/lesson/7"
            className="px-6 py-3 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700 transition-colors"
          >
            ← Bài trước
          </Link>
          <Link
            href="/courses/japanese/n5/grammar/lesson/9"
