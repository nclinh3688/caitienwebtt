...
export default function N5GrammarLesson7Page() {
  ...
  const saveNotes = () => {
    localStorage.setItem('n5-grammar-lesson7-notes', notes);
    setShowNotesModal(false);
  };

  const loadNotes = () => {
    const savedNotes = localStorage.getItem('n5-grammar-lesson7-notes');
    if (savedNotes) {
      setNotes(savedNotes);
    }
    
    const savedGrammarNotes = localStorage.getItem('n5-grammar-lesson7-grammar-notes');
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2">Bài 7: Động từ cơ bản</h1>
              <p className="text-lg text-gray-600 mt-1">第7課 - どうしのきほん</p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="bg-yellow-100 p-4 rounded-lg mb-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">1. ～ます 形</h3>
                  <p className="text-lg font-medium text-blue-800 mb-2">Thể ます của động từ</p>
                  <p className="text-base text-gray-700">Thể ます của động từ</p>
                </div>
        ...
        <div className="mt-8 flex justify-between">
          <Link
            href="/courses/japanese/n5/grammar/lesson/6"
            className="px-6 py-3 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700 transition-colors"
          >
            ← Bài trước
          </Link>
          <Link
            href="/courses/japanese/n5/grammar/lesson/8"
